...
require_once('cleanurl.php');
  ...
  if( $twitter ) {
   ...
   if( $tumblr ) {
     echo '<a href="'.addScheme($tumblr).'" target="_blank"><img src="http://cdn.hptonline.co.uk/social-contact-display/images/retrocircle/pink/48_48/tumblr.png" height="38" width="37" ></a>&nbsp;';
   }
   if ( $vertical == '1' ) { 
     echo '<br>'; 
   }
