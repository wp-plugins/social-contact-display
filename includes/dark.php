...
// Check if title is set
   ...
   if( $facebook ) {
    echo '<a href="'.$facebook.'" target="_blank"><img src="' . plugins_url( 'social-contact-display/images/dark/social-facebook.png' , dirname(__FILE__) ) . '" ></a>&nbsp;';
   }
   // Check if twitter is set
  if( $twitter ) {
     echo '<a href="'.$twitter.'" target="_blank"><img src="' . plugins_url( 'social-contact-display/images/dark/social-twitter.png' , dirname(__FILE__) ) . '" ></a>&nbsp;';
   }
   // Check if gplus is set
   if( $gplus ) {
     echo '<a href="'.$gplus.'" target="_blank"><img src="' . plugins_url( 'social-contact-display/images/dark/social-googleplus.png' , dirname(__FILE__) ) . '" ></a>&nbsp;';
   }
   // Check if linkedin is set
   if( $linkedin ) {
     echo '<a href="'.$linkedin.'" target="_blank"><img src="' . plugins_url( 'social-contact-display/images/dark/social-linkedin.png' , dirname(__FILE__) ) . '" ></a>&nbsp;';
   }
   // Check if youtube is set
   if( $youtube ) {
     echo '<a href="'.$youtube.'" target="_blank"><img src="' . plugins_url( 'social-contact-display/images/dark/social-youtube.png' , dirname(__FILE__) ) . '" ></a>&nbsp;';
   }
//   if( $pinterest ) {
