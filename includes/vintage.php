...
// Check if title is set
   ...
   if( $facebook ) {
    echo '<a href="'.$facebook.'" target="_blank"><img src="' . plugins_url( 'images/vintage/facebook.png' , dirname(__FILE__) ) . '" height="38" width="37" ></a>&nbsp;';
   }
   // Check if twitter is set
  if( $twitter ) {
     echo '<a href="'.$twitter.'" target="_blank"><img src="' . plugins_url( 'images/vintage/twitter.png' , dirname(__FILE__) ) . '" height="38" width="37" ></a>&nbsp;';
   }
   // Check if gplus is set
   if( $gplus ) {
     echo '<a href="'.$gplus.'" target="_blank"><img src="' . plugins_url( 'images/vintage/googleplus.png' , dirname(__FILE__) ) . '" height="38" width="37" ></a>&nbsp;';
   }
...
//   }
   ...
   if( $youtube ) {
     echo '<a href="'.$youtube.'" target="_blank"><img src="' . plugins_url( 'images/vintage/youtube.png' , dirname(__FILE__) ) . '" height="38" width="37" ></a>&nbsp;';
   }
   if( $pinterest ) {
     echo '<a href="'.$pinterest.'" target="_blank"><img src="' . plugins_url( 'images/vintage/pinterest.png' , dirname(__FILE__) ) . '" height="38" width="37" ></a>&nbsp;';
   }   
?>