<?php
  ...
  if( $scd_option['scd_url_txt_twitter'] ) {
   ...
   if( $scd_option['scd_url_txt_tumblr'] ) {
     echo '<a href="'.$scd_option['scd_url_txt_gplus'].'" target="_blank"><img src="http://cdn.hptonline.co.uk/social-contact-display/images/purple-rimmed/tumblr.png" height="38" width="37" ></a>&nbsp;';
   }
   if ( $scd_option['scd_vertical_checkbox'] == '1' ) { 
     echo '<br>'; 
   }
